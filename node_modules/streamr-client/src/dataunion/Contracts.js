...
class Contracts {
    ...
    async fetchDataUnionMainnetAddress(dataUnionName, deployerAddress) {
        const provider = this.ethereum.getMainnetProvider();
        const factoryMainnet = new contracts_1.Contract(this.factoryMainnetAddress, abi_2.factoryMainnetABI, provider);
        return factoryMainnet.mainnetAddress(deployerAddress, dataUnionName);
    }
    getDataUnionMainnetAddress(dataUnionName, deployerAddress) {
        ...
        const codeHash = keccak256_1.keccak256(`0x3d602d80600a3d3981f3363d3d373d3d3d363d73${this.templateMainnetAddress.slice(2)}5af43d82803e903d91602b57fd5bf3`);
    ...
    async fetchDataUnionSidechainAddress(duMainnetAddress) {
        const provider = this.ethereum.getMainnetProvider();
        const factoryMainnet = new contracts_1.Contract(this.factoryMainnetAddress, abi_2.factoryMainnetABI, provider);
        return factoryMainnet.sidechainAddress(duMainnetAddress);
    }
    getDataUnionSidechainAddress(mainnetAddress) {
    ...
    async deployDataUnion({ ownerAddress, agentAddressList, duName, deployerAddress, adminFeeBN, sidechainRetryTimeoutMs, sidechainPollingIntervalMs, confirmations, gasPrice }) {
        ...
        const tx = await factoryMainnet.deployNewDataUnion(ownerAddress, adminFeeBN, agentAddressList, duName, ethersOptions);
