...
const UnsubscribeResponse_1 = __importDefault(require("./UnsubscribeResponse"));
const Serializer_1 = require("../../../Serializer");
const VERSION = 1;
class UnsubscribeResponseSerializerV1 extends Serializer_1.Serializer {
    toArray(unsubscribeResponse) {
        return [
            VERSION,
            ControlMessage_1.default.TYPES.UnsubscribeResponse,
    ...
    fromArray(arr) {
        ...
        streamId, streamPartition,] = arr;
        return new UnsubscribeResponse_1.default({
            version, streamId, streamPartition, requestId: ControlMessage_1.PLACEHOLDER_REQUEST_ID_PROTOCOL_V1
        });
    }
}
...
//# sourceMappingURL=UnsubscribeResponseSerializerV1.js.map